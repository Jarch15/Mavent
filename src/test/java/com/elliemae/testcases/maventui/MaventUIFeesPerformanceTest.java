...
public class MaventUIFeesPerformanceTest extends EllieMaeApplicationBase 
{
	public static Logger _log = Logger.getLogger(MaventUIFeesPerformanceTest.class);
	
	/* Author : Jayesh Bhapkar
	 * Description : This is automated test method for MaventUIFeesPerformance test case.
	 *  */	
	...
	public void verifyMaventUI(HashMap<String, String> testData) 
	{
		...
		EllieMaeLog.log(_log, "MaventUIFeesPerformance test Starts",EllieMaeLogLevel.reporter);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_Login_Page", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_Login_Success", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_LoanData_page", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TilHUD_page", CommonUtility.currentTimeStamp);
		
		// Template
		maventTilHudPage.applyTemplate(testData);
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TILHUD_Apply_Template", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TILHUD_Template_AddColumnBefore", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TILHUD_Template_AddColumnAfter", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TILHUD_Template_DeleteColumn", CommonUtility.currentTimeStamp);
		numberOfColumnsAfter = maventTilHudPage.getNumberOfTemplateColumnsOnPage();
		EllieMaeLog.log(_log, "Number of columns After : "+numberOfColumnsAfter, EllieMaeLogLevel.reporter);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TILHUD_Template_SwapColumn", CommonUtility.currentTimeStamp);
		numberOfColumnsAfter = maventTilHudPage.getNumberOfTemplateColumnsOnPage();
		EllieMaeLog.log(_log, "Number of columns After : "+numberOfColumnsAfter, EllieMaeLogLevel.reporter);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TILHUD_Template_AddRowBefore", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TILHUD_Template_AddRowAfter", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TILHUD_Template_DeleteRow", CommonUtility.currentTimeStamp);
		numberOfRowsAfter = maventTilHudPage.getNumberOfTemplateRowsOnPage();
		EllieMaeLog.log(_log, "Number of rows After : "+numberOfRowsAfter, EllieMaeLogLevel.reporter);
		Assert.assertEquals(numberOfRowsBefore-1, numberOfRowsAfter, "Row not deleted");
		
		maventTilHudPage.resetTemplate(testData);
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TILHUD_Reset_Template", CommonUtility.currentTimeStamp);		
		...
		for(int i=0; i<50;i++)
		{
			maventTilHudPage.addFeesDynamically(testData);
		}
	
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_TILHUD_Add_Fees", CommonUtility.currentTimeStamp);
		...
		maventMIBuyPage.navigateToMIBuyPage();
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_MIBUY_Page", CommonUtility.currentTimeStamp);
		maventMIBuyPage.verifyMIbuylink(testData);
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_MIBUY_AddData", CommonUtility.currentTimeStamp);
		
		/* RESPA Page - test web elements */
		maventRESPAPage.navigateToRESPAPage();
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_RESPA_Page", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_SaveLoanData", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_AbilityToRepayPage", CommonUtility.currentTimeStamp);
		...
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_AdvanceSettingPage", CommonUtility.currentTimeStamp);
		
		
		/* Navigate to TILAHUD page, add one fee and do loan review */
		maventTilHudPage.navigateToTILAHUDPage();	
		maventTilHudPage.addFeesDynamically(testData);
		sampleSOPPage.reviewLoan();
		CommonUtilityApplication.threadWait(15000);
		CommonUtilityApplication.takeScreenShot(testData, "MaventUIFeesPerformanceTest_ReviewLoan_on_TILHUDPage", CommonUtility.currentTimeStamp);
		...
		EllieMaeLog.log(_log, "MaventUIFeesPerformance test Ends",EllieMaeLogLevel.reporter);
	}

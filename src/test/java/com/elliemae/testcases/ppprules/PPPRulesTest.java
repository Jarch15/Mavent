package com.elliemae.testcases.ppprules;
 ...
 * Description : Test Class for validation of PPP rules.
 */
public class PPPRulesTest extends EllieMaeApplicationBase {

	HashMap<String, String> dataBeanMap = new HashMap<>();
	public static Logger _log = Logger.getLogger(PPPRulesTest.class);

 	/**
 	 * <b>Author: Jayesh Bhapkar
 	 * <b>Name:</b>verifyPPPRules
 	 * <b>Description:</b> This is a test method to process the input
 	 * xml file and verify expected output with actual result for PPP rules regression. 
 	 * 
 	 * @param testData 
 	 * 
 	 **/
	@Test(dataProvider = "get-test-data-method")
	public void verifyPPPRules(HashMap<String, String> testData, ITestContext context)
	{
		...
		inputDirectoryPath = inputDirectoryPath + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "com" + File.separator + "elliemae" + File.separator +"ppprules"+ File.separator +"input";;

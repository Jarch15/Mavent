package com.elliemae.testcases.keepupfunctional;
 ...
 * Description : Test Class for validation of keepUp functional Mavent test cases.
 */
public class KeepUpFunctionalMaventTest extends EllieMaeApplicationBase {

	HashMap<String, String> dataBeanMap = new HashMap<>();
	public static Logger _log = Logger.getLogger(KeepUpFunctionalMaventTest.class);

 	/**
 	 * <b>Author: Jayesh Bhapkar
 	 * <b>Name:</b>verifyKeepUpFunctionalMavent
 	 * <b>Description:</b> This is a test method to process the input
 	 * xml file and verify expected output with actual result for KeepUp functional
 	 * Mavent Test cases. 
 	 * 
 	 * @param testData 
 	 * 
	...
	public void verifyKeepUpFunctionalMavent(HashMap<String, String> testData, ITestContext context)
	{
		...
		additionalDataFilePath = CommonUtilityApplication.getRelativeFilePath("data",
				"KeepUpFunctionalMaventTest_data.xlsx");
		...
		inputDirectoryPath = inputDirectoryPath + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "com" + File.separator + "elliemae" + File.separator +"keepupfunctional"+ File.separator +"input";

package com.elliemae.testcases.enterpriseengine;
 ...
 * Description : Test Class for Enterprise Engine Test automation.
 */
public class EnterpriseEngineTest extends EllieMaeApplicationBase {
	...
	public void verifyEnterpriseEngine(HashMap<String, String> testData, ITestContext context) 
	{
		...
		additionalDataFilePath = CommonUtilityApplication.getRelativeFilePath("data",
				"EnterpriseEngineTest_data.xlsx");

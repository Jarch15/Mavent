 ...
 * Description : Test Class for TILA Respa rules Test automation.
 */
public class TilaRespaRulesTest extends EllieMaeApplicationBase {
	...
	public void verifyTilaRespaRules(HashMap<String, String> testData, ITestContext context) 
	{

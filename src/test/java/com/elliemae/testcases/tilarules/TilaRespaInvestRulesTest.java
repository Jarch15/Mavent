 ...
 * Description : Test Class for TILA Respa Invest rules Test automation.
 */
public class TilaRespaInvestRulesTest extends EllieMaeApplicationBase {
	...
	public void verifyTilaRespaInvestRules(HashMap<String, String> testData, ITestContext context) 
	{
		...
		additionalDataFilePath = CommonUtilityApplication.getRelativeFilePath("data",
				"TilaRespaInvestRulesTest_data.xlsx");

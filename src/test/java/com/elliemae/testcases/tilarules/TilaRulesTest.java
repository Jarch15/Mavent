 ...
 * Description : Test Class for TILA rules Test automation.
 */
public class TilaRulesTest extends EllieMaeApplicationBase {
	...
	public void verifyTilaRules(HashMap<String, String> testData, ITestContext context) 
	{

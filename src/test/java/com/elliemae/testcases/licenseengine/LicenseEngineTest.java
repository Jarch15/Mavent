package com.elliemae.testcases.licenseengine;
 ...
 */
public class LicenseEngineTest extends EllieMaeApplicationBase {

	HashMap<String, String> dataBeanMap = new HashMap<>();
	public static Logger _log = Logger.getLogger(LicenseEngineTest.class);

 	/**
 	 * <b>Author: Jayesh Bhapkar
 	 * <b>Name:</b>verifyPPPRules
 	 * <b>Description:</b> This is a test method to process the input
 	 * xml file and verify expected output with actual result for License Engine regression. 
 	 * 
 	 * @param testData 
 	 * 
 	 **/
	@Test(dataProvider = "get-test-data-method")
	public void verifyLicenseEngine(HashMap<String, String> testData, ITestContext context)
	{

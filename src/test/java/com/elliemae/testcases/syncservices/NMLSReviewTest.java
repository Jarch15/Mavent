...
public class NMLSReviewTest  extends EllieMaeApplicationBase 
{

	HashMap<String, String> dataBeanMap = new HashMap<>();
	public static Logger _log = Logger.getLogger(NMLSReviewTest.class);
	...
	public void nmlsReview(HashMap<String,String> testData)
	{
        ...
        for(String fileToProcess : filesToProcess)
        {
			...
			try 
			{
				responseMap = ObjSOAPMaventWebServiceCall.syncWebServiceCall(testData,testCaseMethodData,"nmlsReview",fileToProcess);
			...
			{
				String responseBody = ObjSOAPMaventWebServiceCall.getResponseXMLBody(responseMap, fileToProcess, testData,"nmlsReview");
				String baseXMLFile ="";
				if(CommonUtilityApplication.isExecutedFromEMDomain())
				{

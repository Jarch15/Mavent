...
public class ResidualIncomeLookUpTest  extends EllieMaeApplicationBase 
{

	HashMap<String, String> dataBeanMap = new HashMap<>();
	public static Logger _log = Logger.getLogger(ResidualIncomeLookUpTest.class);
	...
	public void getResidualIncomeThreshold(HashMap<String,String> testData)
	{
		...
		additionalDataFilePath = CommonUtilityApplication.getRelativeFilePath("data",
				"ResidualIncomeLookUpTest_data.xlsx");
        ...
        for(String fileToProcess : filesToProcess)
        {
			...
			try 
			{
				responseMap = ObjSOAPMaventWebServiceCall.syncWebServiceCall(testData,testCaseMethodData,"residualIncomeLookUp",fileToProcess);
			...
			{
				String responseBody = ObjSOAPMaventWebServiceCall.getResponseXMLBody(responseMap, fileToProcess, testData,"residualIncomeLookUp");
				String baseXMLFile ="";
				if(CommonUtilityApplication.isExecutedFromEMDomain())
				{

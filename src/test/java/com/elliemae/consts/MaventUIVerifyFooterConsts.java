...
public class MaventUIVerifyFooterConsts
{
	//Reports
	...
	public static final String BatchFile_Txt ="//input[@name='batchFile']";
	public static final String FILEFORMAT ="fileFormat";
	public static final String IMPORTLOAN_CONTINUE_BTN ="//input[@value='CONTINUE']";
	
	
	
	public static final String LOANPOOL_LINK ="QTP-Import";
	public static final String LOANPOOL_DONE_BTN ="//input[@class='button2' and @value='DONE']";
	public static final String LOANBATCH_LIST_LINK ="//a[contains(@href,'loanBatchList')]";
	public static final String BATCHLOAD_RESULT_LINK ="//a[contains(@href,'batchLoadResult')]";
	public static final String GETLOANGROUP_CONTENT_LINK ="//a[contains(@href,'getLoanGroupContent')]";
	public static final String LOANDATA_LINK ="//a[contains(@href,'getDocument')]";
	public static final String COMMENT_TAB_LINK ="//a/img[contains(@src,'images/loandata-comment.gif')]";
	public static final String QTPTEMPLATE_LINK ="//a[contains(text(),'QTP-Template1')]";
